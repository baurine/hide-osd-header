...
A OpenSearch Dashboards plugin to hide the page header.
...
1. Run `yarn build` under the root folder of this repo, it will ask you what version the target OpenSearch Dashboards, in this time (2022.03.02), fill `1.2.0`
